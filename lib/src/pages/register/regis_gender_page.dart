              ...
              child: Container(
                ...
                child: Column(
                  children:<Widget>[
                      ...
                      child: Stack(
                        children: <Widget>[
                          Row(
                            ...
                            children: <Widget>[
                              Text('Paso 5/7', style:TextStyle(fontWeight: FontWeight.bold, fontSize: 20, color: Colors.grey[700]))
                            ],
                          ),
                          FlatButton(
                              onPressed: (){
                    ...
                    Text("Género", style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold, color: Colors.grey[700]),),
                    Container(
                        margin: EdgeInsets.only(left: 30.0, right: 30.0, top: 15, bottom: 15),
                        child: Text("Por favor elige el género del visitante.",style: TextStyle(color: Colors.grey[700]),)
                    ),
                    Card(
